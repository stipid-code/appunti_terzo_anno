...
è un anello quando
 ...
 - la somma $+$ è un operatore binario
   ...
   da $R\times R$[fn::che ha in ingresso 2 elementi dell'anello]
   in $R$ che[fn::che ha come uscita un elemento dell'anello]
   - è commutativo ($a+b = b+a$ quando $a,b \in R$)
   - è associativo ($a+(b+c) = (a+b)+c$ quando $a,b,c \in R$)
 - il prodotto $\cdot$ è un operatore binario da $R\timesR$ in $R$ che
 ...
 - $1$ è l'elemento neutro del prodotto ($a \cdot 1 = a \forall a \in R)
